...
/// </summary>
public class FloorFinderCustom : MonoBehaviour 
{
	/// <summary>
	...
	public void Update()
	{
		...
		if (m_pointCloudFloor.m_floorFound && m_pointCloud.m_floorFound)
		{
			...
			if (Physics.Raycast(Camera.main.ScreenPointToRay(new Vector3(Screen.width / 2.0f, Screen.height / 2.0f)), out hitInfo))
			{
				...
				Vector3 cameraBase = new Vector3(Camera.main.transform.position.x, hitInfo.point.y+4, Camera.main.transform.position.z);
